...
%changelog
* Wed May 27 2026 Jamie Curnow <jc@jc21.com> 0.11.5-1
- https://github.com/regclient/regclient/releases/tag/v0.11.5

* Tue May 12 2026 Jamie Curnow <jc@jc21.com> 0.11.4-1
- https://github.com/regclient/regclient/releases/tag/v0.11.4
